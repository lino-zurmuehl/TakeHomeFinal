...
data_sen <- data_name %>%
  right_join(wiki_senators, by = "RealName")# joining
...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
#Removing the stemming funktion to get full words in the wordcloud
...
plot_usmap(data = corona_cases, values = "CasesPop" ) + 
  scale_fill_continuous( low = "white", high = "red", name = "Cases per 100k inhabitants", limits=c(0,2000)) +
  theme(legend.position = "right")
```
## Us Map Party
