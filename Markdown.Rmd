...
This article tries to address the following research question: Is there a connection between a high number of Covid cases in one state and a low sentiment of the tweets posted by the Senators of this particular state. 
...
```{r, echo=FALSE, fig.show="hold", out.width="50%", message=FALSE, warning=FALSE}
plot_usmap(data = rel_post_1_tweet, values = "Party" ) + 
  scale_fill_manual( values = c( "blue", "grey", "red"), name = "Party")+
  theme(legend.position = "right")
